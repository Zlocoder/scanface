	...
	<div class="post-content">
		...
		<div class="content-inner">
			...
			<?php if ( has_post_thumbnail() ) {
                 ...
                 if (get_post_type($post->ID) == 'testimonial') {
                     $fields = get_post_custom($post->ID);
                     echo '<span class="testimonial-client-description">';
                         echo '<span class="testimonial-client-name">' . $fields['testimonial_client_name'][0] . '</span>, ';
                         echo '<span class="testimonial-company-name">' . $fields['testimonial_client_company_name'][0] . '</span>';
                     echo '</span>';
                 }
