			...
			<div class="container">
				...
				<div class="col span_5">
                    <?php if(!empty($options['footer-copyright-text'])) { ?>
					    <p><?=$options['footer-copyright-text'];?></p>
                    <?php } ?>
				</div><!--/span_6-->
				...
				<div class="col span_7 col_last">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="<?=get_permalink(get_page_by_title("О проекте"))?>">О проекте</a></li>
                            <li><a href="<?=get_permalink(get_page_by_title("Контакты"))?>">Контакты</a></li>
                            <li><a href="<?=get_permalink(get_page_by_title("Политика и условия использования"))?>">Политика и условия использования</a></li>
                        </ul>
                    </nav>
				</div><!--/span_6-->
