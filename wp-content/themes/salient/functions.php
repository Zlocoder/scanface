...
function nectar_register_js() {
	...
	if (!is_admin()) { 
        ...
        wp_register_script('magnific-popup', get_template_directory_uri() . '/js/jquery.magnific-popup.js', 'jquery', '1.0', TRUE);
        ...
        //wp_register_script('jquery-touch', get_template_directory_uri() . '/js/jquery.touch.min.js', 'jquery', '0.2', true);
        wp_register_script('jquery-touch', get_template_directory_uri() . '/js/jquery.touch.js', 'jquery', '0.2', true);
        //wp_register_script('jquery-mobile-custom', get_template_directory_uri() . '/js/jquery.mobile-1.4.0.min.js', array('jquery'), '1.4.0', true);
        wp_register_script('jquery-ui-touch-punch', get_template_directory_uri() . '/js/jquery.ui.touch-punch.min.js', array('jquery', 'jquery-ui-core'), '0.2.2', true);
        //wp_register_script('jquery-event-ue', get_template_directory_uri() . '/js/jquery.event.ue.js', 'jquery', '0.3.2', TRUE);
...
function nectar_page_specific_js() {
    ...
    if ( is_page_template('upload.php') ) {
        wp_enqueue_script('uploader', get_template_directory_uri() . '/js/jquery.fileupload.js', array('jquery'), '1.0', true);
        wp_enqueue_script('upload', get_template_directory_uri() . '/js/upload.js', array('jquery', 'uploader'), '1.0', true);
    }

    if ( is_page_template('markers.php') ) {
        wp_enqueue_script('jquery-ui-mousehold', get_template_directory_uri() . '/js/jquery.ui.mousehold.js', array('jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-mouse'), '1.10.3', true);
        wp_enqueue_script('jquery-ui-draggable');
        wp_enqueue_script('markers', get_template_directory_uri() . '/js/markers.js', array('jquery'), '1.0', true);
    }

    if (is_page_template('result.php')) {
        wp_enqueue_script('report', get_template_directory_uri() . '/js/report.js', array('jquery'), '1.0', true);
    }

    if (is_page_template('history.php')) {
        wp_enqueue_script('jquery-multiselect', get_template_directory_uri() . '/js/jquery.multiselect.js', array('jquery', 'jquery-ui-core', 'jquery-ui-widget'), '1.0', true);
        wp_enqueue_script('filter.js', get_template_directory_uri() . '/js/filter.js', array('jquery'), '1.0', true);
        wp_enqueue_script('report', get_template_directory_uri() . '/js/report.js', array('jquery'), '1.0', true);
    }

    if (is_page_template('specifications.php')) {
        wp_enqueue_script('jquery-ui-draggable');
    }
...
function add_routes() {
    ...
    if (empty($rules['markers/([0-9]+)/?$'])) {
        add_rewrite_rule('markers/([0-9]+)/?$', 'index.php?pagename=markers&facecheck_photo_id=$matches[1]', 'top');
        flush_rewrite_rules();
    }
}
